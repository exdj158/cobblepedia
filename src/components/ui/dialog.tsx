...
const DialogPortal: Component<DialogPrimitive.DialogPortalProps> = (props) => {
  ...
  return (
    <DialogPrimitive.Portal {...rest}>
      <div class="fixed inset-0 z-50">{props.children}</div>
...
const DialogOverlay = <T extends ValidComponent = "div">(
  ...
  return (
    <DialogPrimitive.Overlay
      class={cn(
        "data-[closed]:fade-out-0 data-[expanded]:fade-in-0 fixed inset-0 z-50 bg-background/80 data-[closed]:animate-fadeOut data-[expanded]:animate-fadeIn",
        props.class
      )}
      {...rest}
    />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        class={cn(
          "fixed top-[50%] left-[50%] z-50 grid max-h-screen w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto border bg-background p-6 shadow-lg duration-200 data-[closed]:animate-flyUpAndScaleExit data-[expanded]:animate-flyUpAndScale sm:rounded-lg",
          props.class
        )}
        {...rest}
      >
